...
Namespace SchedulerResourcesManagement
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			AddHandler carsTableAdapter.Adapter.RowUpdated, AddressOf carsTableAdapter_RowUpdated
		...
		Private Sub Appointments_Modified(ByVal sender As Object, ByVal e As PersistentObjectsEventArgs) Handles schedulerStorage1.AppointmentsChanged, schedulerStorage1.AppointmentsInserted, schedulerStorage1.AppointmentsDeleted
			carSchedulingTableAdapter.Update(carsDBDataSet)
		End Sub

		Private Sub Resources_Modified(ByVal sender As Object, ByVal e As PersistentObjectsEventArgs) Handles schedulerStorage1.ResourcesDeleted, schedulerStorage1.ResourcesChanged, schedulerStorage1.ResourcesInserted
		...
		Private Sub carsTableAdapter_RowUpdated(ByVal sender As Object, ByVal e As OleDbRowUpdatedEventArgs)
			If e.Status = UpdateStatus.Continue AndAlso e.StatementType = StatementType.Insert Then
				Dim id As Integer = 0
				Using cmd As New OleDbCommand("SELECT @@IDENTITY", carsTableAdapter.Connection)
					id = CInt(Fix(cmd.ExecuteScalar()))
				End Using
				e.Row("ID") = id
			End If
        ...
        Private Sub schedulerControl1_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraScheduler.PopupMenuShowingEventArgs) Handles schedulerControl1.PopupMenuShowing
		...
		Private Sub OnAddResource(ByVal sender As Object, ByVal e As EventArgs)
			...
			Using form As New ResourceForm(resource)
