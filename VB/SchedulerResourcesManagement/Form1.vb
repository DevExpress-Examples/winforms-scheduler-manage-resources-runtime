...
'#End Region  ' Data-Related Events
        ...
        Private Sub OnAddResource(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Using form As ResourceForm = New ResourceForm(resource, schedulerStorage1)
        ...
        Private Function IsAssignedToCurrentResource(ByVal apt As Appointment) As Boolean
            Return Equals(apt.ResourceId, ResourceEmpty.Id) OrElse Convert.ToInt32(apt.ResourceId) = Convert.ToInt32(schedulerControl1.SelectedResource.Id)
        End Function
