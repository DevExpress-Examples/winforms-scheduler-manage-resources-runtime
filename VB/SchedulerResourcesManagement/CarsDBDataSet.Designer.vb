...
Namespace SchedulerResourcesManagement
    ...
    Public Partial Class CarsDBDataSet
        ...
        Public Partial Class CarSchedulingDataTable
            Inherits Global.System.Data.TypedTableBase(Of SchedulerResourcesManagement.CarsDBDataSet.CarSchedulingRow)
        ...
        Public Partial Class CarsDataTable
            Inherits Global.System.Data.TypedTableBase(Of SchedulerResourcesManagement.CarsDBDataSet.CarsRow)
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Function AddCarsRow(ByVal Model As String, ByVal Picture As Byte(), ByVal Color As Integer) As CarsRow
...
Namespace SchedulerResourcesManagement.CarsDBDataSetTableAdapters
    ...
    Public Partial Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Model` IS NULL) OR (`Model`" & " = ?)) AND ((? = 1 AND `Color` IS NULL) OR (`Color` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, (CByte((0))), (CByte((0))), "ID", Global.System.Data.DataRowVersion.Original, False, Nothing))
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Model` = ?, `Picture` = ?, `Color` = ? WHERE ((`ID` = ?) AND (" & "(? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Color` IS NULL) O" & "R (`Color` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(CInt((0))).Connection = Me.Connection
            Me._commandCollection(CInt((0))).CommandText = "SELECT        ID, Model, Picture, Color" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "FROM            Cars"
            Me._commandCollection(CInt((0))).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)>
        Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Model As String, ByVal Original_Color As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value =(CInt((Original_ID)))
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value =(CObj((0)))
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value =(CStr((Original_Model)))
            End If
        ...
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)>
        Public Overridable Function Insert(ByVal Model As String, ByVal Picture As Byte(), ByVal Color As Global.System.Nullable(Of Integer)) As Integer
            If(Equals(Model, Nothing)) Then
                Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((0))).Value =(CStr((Model)))
            End If

            If(Picture Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = CType((Picture), Byte())
            End If

            If(Color.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value =(CInt((Color.Value)))
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = Global.System.DBNull.Value
            End If
        ...
        <Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(ByVal Model As String, ByVal Picture As Byte(), ByVal Color As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_Model As String, ByVal Original_Color As Global.System.Nullable(Of Integer)) As Integer
            If(Equals(Model, Nothing)) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value =(CStr((Model)))
            End If

            If(Picture Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = CType((Picture), Byte())
            End If

            If(Color.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value =(CInt((Color.Value)))
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Global.System.DBNull.Value
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value =(CStr((Original_Model)))
            End If
