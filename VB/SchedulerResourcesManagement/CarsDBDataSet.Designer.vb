...
Namespace SchedulerResourcesManagement.CarsDBDataSetTableAdapters
    ...
    Public Partial Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Model` IS NULL) OR (`Model`" & " = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, (CByte((0))), (CByte((0))), "ID", Global.System.Data.DataRowVersion.Original, False, Nothing))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Model`, `Picture`) VALUES (?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Model` = ?, `Picture` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `M" & "odel` IS NULL) OR (`Model` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(CInt((0))).Connection = Me.Connection
            Me._commandCollection(CInt((0))).CommandText = "SELECT        ID, Model, Picture" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "FROM            Cars"
            Me._commandCollection(CInt((0))).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        Public Overridable Function Update(ByVal Model As String, ByVal Picture As Byte(), ByVal Original_ID As Integer, ByVal Original_Model As String) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value =(CInt((Original_ID)))
            If(Equals(Original_Model, Nothing)) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value =(CObj((1)))
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value =(CObj((0)))
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value =(CStr((Original_Model)))
            End If
